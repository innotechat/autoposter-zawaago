...
async function validateImage(env: Env, imageUrl: string) {
  ...
  if (!url.pathname.startsWith("/api/autoposter/assets/")) throw new Error("Episode image must be a generated R2 asset from this Autoposter.");
  let objectKey = "";
